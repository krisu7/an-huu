...
package com.haibison.android.lib.anhuu.ui.widget;
 ...
 * @since v5.1 beta
 */
public class AnHuuSearchView extends LinearLayout {

    private static final String CLASSNAME = AnHuuSearchView.class.getName();
    ...
    public static interface OnQueryTextListener {
         ...
         * {@link AnHuuSearchView#getSearchText()}).
         * </p>
         * 
         * @param query
     ...
     *            {@link Context}.
     */
    public AnHuuSearchView(Context context) {
        this(context, null);
    }// AnHuuSearchView()
     ...
     *            {@link AttributeSet}.
     */
    public AnHuuSearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
